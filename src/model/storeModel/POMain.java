...
public class POMain {
    ...
    public POMain(String poID, String venderCode, String account, String createTime, float tipFee, float productTotal, float poTotal, String payType, float prePayFee, int status, String remark, String stockTime, String stockUser, String payTime, String payUser, String prePayTime, String prePayUser, String endTime, String endUser) {
        this.poID = poID;
