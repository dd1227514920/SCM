...
@WebServlet(name = "PomainUpdateSaveServlet",urlPatterns ={"/purchaseservlet/PomainUpdateSaveServlet"} )
public class PomainUpdateSaveServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		pd.updatePomain(pm, lpi , request);
