...
@WebServlet(name = "PomainSelectServlet",urlPatterns ={"/purchaseservlet/PomainSelectServlet"} )
public class PomainSelectServlet extends HttpServlet {
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			List<Pomain> lp = pd.querySomePomains(poId,startTime,endTime,venderCode,payType);
