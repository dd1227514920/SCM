...
<html>
<head>
<title>销售单了结sale_finished</title>
...
<body>
	<div id="m">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td width="40px" nowrap class="toolbar" onClick="showSoitem()"><img
					src="../images/new.gif" />明细</td>
				<td width="40px" nowrap class="toolbar"><img
					src="../images/search.gif" /><a
					href="/sales/SomainFinishedQueryServlet">查询可了结的销售单</a></td>
			</tr>
		</table>
		<div>付款方式：货到付款</div>
		<table width="100%" border="0" align="center" cellspacing="1"
			...
			<c:forEach items="${requestScope.somainFinished_HDFK}" var="somain">
				<tr>
					...
					<td align="center" onclick="chooseSale(this)"><span
						onclick="finish(this)">了结</span></td>
				</tr>
			</c:forEach>
		</table>
		<br />
		...
		<table width="100%" border="0" align="center" cellspacing="1"
			...
			<c:forEach items="${requestScope.somainFinished_KDFH}" var="somain">
				<tr>
					<td align="center" onclick="chooseSale(this)" class="choose"></td>
					<td align="center" onclick="chooseSale(this)">${somain.soid}</td>
					<td align="center" onclick="chooseSale(this)">${somain.createTime}</td>
		...
		<table width="100%" border="0" align="center" cellspacing="1"
			...
			<c:forEach items="${requestScope.somainFinished_YFKFH}" var="somain">
				<tr>
					<td align="center" onclick="chooseSale(this)" class="choose"></td>
					<td align="center" onclick="chooseSale(this)">${somain.soid}</td>
					<td align="center" onclick="chooseSale(this)">${somain.createTime}</td>
		...
		<form id="finishSoitem" action="/sales/SomainFinishServlet"
			method="post">
			<input type="hidden" id="soid_finished" name="soid_finished" />
		</form>
		<script type="text/javascript" src="../script/common.js"></script>
		<script type="text/javascript" src="../script/sales.js"></script>
		<script type="text/javascript">
		if ("${requestScope.finishDone}" == "yes") {
			alert("了结成功！")
		} else if ("${requestScope.finishDone}" == "no") {
			alert("了结失败！");
		}
	</script>
</body>
