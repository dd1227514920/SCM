...
<script language="javascript" type="text/javascript">
	...
	function re(){
		...
		function c(){
			window.location.href="addGoodsClassTeacher.jsp";
			}

    function showCatrgory() {
        window.location="/servlet/storeServlet/CategoryServlet";
        target="mainFrame";
    }
...
<table width="100%"  border="0" align="center" cellspacing="1" class="c">
  ...
  <c:forEach items="${requestScope.caterory}" var="cate">
    <tr>
      <td align="center">${cate.categoryId}</td>
      <td align="center">${cate.name}</td>
      <td align="center">${cate.remark}</td>
    </tr>
  </c:forEach>
  <%--<tr>--%>
    <%--<td align="center">1</td>--%>
    <%--<td align="center">王朝</td>--%>
	<%--<td align="center">杭州的</td>--%>
