...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td nowrap class="title1">您的位置：工作台面－－采购管理－－供应商管理</td>
  </tr>
</table>
...
<table id="headTable" width="100%"  border="0" align="center" class="a1">
  <tr align="justify">
    ...
    <td><input type="text" size="15"/>
      <span class="requred_symbol">*</span></td>
    <td>供应商的名称</td>
    <td><input type="text" size="15" onBlur="test()"/>
  ...
  <tr align="justify">
    ...
    <td><input type="text" size="15"/>
        <span class="requred_symbol">*</span></td>
    <td>填单日期</td>
    <td><input name="tdrq" type="text" size="15"  readonly="readonly"/>
        <span class="requred_symbol">*</span>
  ...
  <tr align="justify">
    ...
    <td><input type="text" size="15"/>
      <span class="requred_symbol">*</span></td>
    <td>截止日期</td>
    <td><input name="jzrq" type="text" size="15"  readonly="readonly">
      <span class="requred_symbol">*</span>
  ...
  否</td>
    <td>实提日期</td>
    <td><input name="strq" type="text" size="15"  readonly="readonly">
  ...
  <tr align="justify">
    <td>录入日期</td>
    <td><input name="lrrq" type="text" size="15"  readonly="readonly">
    ...
    <td>审核日期</td>
    <td><input name="shrq" type="text" size="15" readonly="readonly">
...
<div id="productDiv" style="visibility: hidden;" class="product">
	...
	<table width="100%"  border="0" align="center" cellspacing="1" class="a1" id="spxxTable">
	  ...
	  <tr onClick="selectItem(this)" onMouseOver="OMO1(event)" onDblClick="choice(2)" align="center">
	    <td>&nbsp;</td>
	    <td>00002</td>
	    <td>西湖大米</td>
	    <td>&nbsp;</td>
	  ...
	  <tr onClick="selectItem(this)" onMouseOver="OMO1(event)"  ondblclick="choice(3)" align="center">
	    <td>&nbsp;</td>
	    <td>00003</td>
	    <td>金龙鱼色拉油</td>
	    <td>10L</td>
