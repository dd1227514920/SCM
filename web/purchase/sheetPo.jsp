...
<form accept="../purchaseservlet/PomainDateServlet" method="get">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr >
  <td class="title1">开始日期<input type="month" name="startTime">
  </td>
  <td class="title1">截止日期<input type="month" name="endTime">
...
<table width="100%"  border="0" align="center" cellspacing="1">
  ...
  <tr>
    <td class="title1" align="center"><a href="../purchaseservlet/PoitemServlet?poId=${pomain.poId}" name="${pomain.poId}">${pomain.poId}</a></td>
    <td class="title1"  align="center">${pomain.createTime}</td>
	<td class="title1" align="center">${pomain.account}</td>
	<td class="title1" align="center">${pomain.venderCode}</td>
    <td class="title1" align="center">${pomain.tipFee}</td>
    <td class="title1" align="center">${pomain.productTotal}</td>
    <td class="title1" align="center">${pomain.poTotal}</td>
    <td class="title1" align="center">${pomain.payType}</td>
    <td class="title1" align="center">${pomain.prePayFee}</td>
    <td class="title1" align="center">${pomain.status}</td>
    <td class="title1" align="center"><a onclick="update(this)">修改</a> <a onclick="deleted(this)">删除</a> </td>
  </tr>
  </c:forEach>
  <tr>
  	<td class="title2"></td>
  </tr>
  <tr><td class="title2" colspan="5">总的单据数：${pListNum }</td>
  <td class="title2" colspan="6">总金额：${pListSum }</td></tr>
</table>
