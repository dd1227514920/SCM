...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td nowrap class="title1">您的位置：采购管理－－采购单了结</td>
  </tr>
</table>
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
...
<table width="100%"  border="0" align="center" cellspacing="1">
  ...
  <tr>
    <td align="center" id="poid"><a href="../purchaseservlet/PoitemServlet?poId=${pomain.poId}">${pomain.poId}</a></td>
    ...
    <td align="center"><a href="../purchaseservlet/PomainOveredServlet?poId=${pomain.poId}" onclick= "return confirm('确定了结?');">了结</a></td>
  </tr>
  </c:forEach>
  <tr>
  	<td class="title2"></td>
